<template>
  <div>
    ...
    >
      ...
      <p
        class="text-white/40 text-xs uppercase tracking-[0.3em] mt-4"
      >
        Cargando citas
      </p>
    </div>
    ...
    >
      ...
      <RouterLink
        ...
        class="inline-block mt-5 px-6 py-3 bg-[#ffb700] text-black text-[10px] font-barber uppercase tracking-[0.2em] rounded hover:bg-[#e6a500] transition-all duration-300"
      >
        Agendar nueva cita
      </RouterLink>
    </div>
